...
generated_code = code_generator(input_string, return_full_text = False, max_new_tokens=1000, do_sample=True, temperature=0.7, top_p=0.9, top_k=50, num_return_sequences=1, pad_token_id=tokenizer.eos_token_id, return_tensors=False, framework='pt')
