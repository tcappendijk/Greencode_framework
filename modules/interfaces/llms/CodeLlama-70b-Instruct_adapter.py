...
class CodeLlama70bInstruct(LLMAdapter):
    ...
    def process_code_prompt(self, code_prompt: str) -> str:
        command = f"""ssh -tt tcappendij@129.152.15.84 'cd data/volume_2/Greencode_framework/ && source venv/bin/activate && torchrun --nproc_per_node 8 CodeLlama/process_code_prompt_instruction.py      --ckpt_dir ../codellama/CodeLlama-70b-Instruct/      --tokenizer_path ../codellama/CodeLlama-70b-Instruct/tokenizer.model     --max_batch_size 1 --prompt "{code_prompt}"'"""
